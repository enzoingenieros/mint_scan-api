...
echo "   # Login"
echo "   export MINTITV_TOKEN=\$(bun run src/index.ts login usuario pass -q)"
echo
echo "   # Procesar"
...
echo "bun build src/index.ts --compile --outfile mintitv-cli"
echo "./mintitv-cli --help"