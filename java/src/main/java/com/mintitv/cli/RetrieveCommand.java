...
import com.mintitv.api.process.ProcessRetrieveService;
import com.mintitv.cli.utils.TechnicalCardPrinter;
...
public class RetrieveCommand {
    ...
    public static void printHelp() {
        System.out.println("Uso: mintitv-cli retrieve <id_proceso> [opciones]");
        System.out.println();
        System.out.println("Recuperar un documento procesado específico de la API de MintITV");
        System.out.println();
        ...
        System.out.println("  mintitv-cli retrieve 731cb083-7d83-4ce7-a0ce-1a3b19b7e422");
        System.out.println("  mintitv-cli retrieve <id> --format resumen");
        System.out.println("  mintitv-cli retrieve <id> --json resultado.json");
    }
}