...
public final class Messages {
    ...
    public static final String TOKEN_REQUIRED = "Token required (--token or MINTSCAN_TOKEN environment variable)";
    public static final String USERNAME_REQUIRED = "Username required (--user or MINTSCAN_USER environment variable)";
    public static final String PASSWORD_REQUIRED = "Password required (--pass or MINTSCAN_PASS environment variable)";
    ...
    public static final String LOGIN_DESCRIPTION = "Authenticate with MintScan API";
    public static final String PROCESS_DESCRIPTION = "Process document images in MintScan API";
    public static final String LIST_DESCRIPTION = "List processed documents from MintScan API";
    public static final String RETRIEVE_DESCRIPTION = "Retrieve a specific document from MintScan API";
    ...
    public static final String RUN_LOGIN_TO_GET_TOKEN = "Run 'mint_scan-cli login' to get a token";
