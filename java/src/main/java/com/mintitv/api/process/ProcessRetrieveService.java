package com.mintitv.api.process;

import com.mintitv.api.exceptions.MintApiException;
import com.mintitv.api.models.ProcessDocument;
...
public class ProcessRetrieveService {
    ...
    public boolean isDocumentReady(ProcessDocument document) {
        return document != null && 
               document.getStatus() == com.mintitv.api.models.ProcessStatus.COMPLETED;
    }
    ...
    public boolean isDocumentFailed(ProcessDocument document) {
        return document != null && 
               (document.getStatus() == com.mintitv.api.models.ProcessStatus.FAILED ||
                document.getStatus() == com.mintitv.api.models.ProcessStatus.ABORTED);
    }
    ...
    public boolean isDocumentProcessing(ProcessDocument document) {
        return document != null && 
               (document.getStatus() == com.mintitv.api.models.ProcessStatus.PENDING ||
                document.getStatus() == com.mintitv.api.models.ProcessStatus.STRAIGHTENING ||
                document.getStatus() == com.mintitv.api.models.ProcessStatus.RECOGNIZING);
    }
}